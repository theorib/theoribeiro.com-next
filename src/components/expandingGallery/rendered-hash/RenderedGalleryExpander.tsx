  ...
  return (
    ...
    >
      <Nav className="bottom-0 left-0 right-0 top-0 order-last flex items-center justify-between p-4 pb-10 sm:absolute  sm:p-3 sm:px-0 md:py-2 ">
        ...
        <ExpandingGridGallery.NavButtonNext className="order-last overflow-clip sm:rounded-e-none">
          <PiCaretRightThin className={iconClassName} />
        </ExpandingGridGallery.NavButtonNext>
        <ExpandingGridGallery.NavButtonClose className="sm:absolute sm:right-3 sm:top-6 sm:mx-0 sm:h-12 sm:w-12 md:right-2">
          <PiXThin
            className={cn([iconClassName, 'sm:w-18 sm:h-18 sm:mx-0 sm:p-0'])}
          />
        </ExpandingGridGallery.NavButtonClose>
      </Nav>
      <article className="col-span-full flex flex-auto flex-col items-center transition-all sm:px-[4.5rem] sm:py-6 md:flex-row md:gap-6 md:px-16 md:py-10 lg:gap-16">
